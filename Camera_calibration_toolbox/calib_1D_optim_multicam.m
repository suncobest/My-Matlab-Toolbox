...
string_save = ['save ' save_name ' n_cam n_ima imsize fc_mat cc_mat kc_mat alpha_vec handcc hand_list np1D rodlen' ...
                       ' Omcc Tcc idm A_cam costs paths pathm telapsed ind_active active_images active_imgviews' ...
