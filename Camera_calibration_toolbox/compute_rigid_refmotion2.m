function [om,T,hand] = compute_rigid_refmotion2(Y,X,SW)

% COMPUTE_RIGID_REFMOTION2 computes the rigid motion (rotation, translation and reflection).
%
...
%
%  See also compute_rigid_refmotion, rigid_refmotion, compose_motion2.
...
% Optimization through algebraic iteration
MaxIter =10;
for iter = 1:MaxIter,
%     fprintf(1,'%d...',iter);
    param = [om;T];
