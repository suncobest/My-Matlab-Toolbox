% % Old_Multicam_Calib_Results*.mat will not be loaded, you have to
...
if Ndata==0,
    ...
    return;
elseif Ndata>1,
    fprintf(1,['Multiple ''Multicam_Calib_Results*.mat'' files found in current directory!\n' ...
