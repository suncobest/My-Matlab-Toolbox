...
flag = 0;
if exist('fc_error', 'var') && exist('err_std', 'var'),
    flag = 1;
end;

fprintf(1,'Display the image distortion of the camera:\n');
...
clabel(C,h);
title('Complete Distortion Model');
...
[C,h]=contour(gx,gy,dr,'k');
clabel(C,h);
title('Tangential Component of the Distortion Model');
...
[C,h]=contour(gx,gy,dr,'k');
clabel(C,h);
title('Radial Component of the Distortion Model');
