function [omckk,Tckk] = compute_extrinsic_init2(x_kk,X_kk,fc,cc,kc,alpha_c,hand)

% compute_extrinsic_init2
%
...
%
% See also compute_extrinsic_init_mirror, compute_extrinsic_init.
