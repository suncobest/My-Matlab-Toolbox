...
if ~exist('strnum_cell','var')||~exist('fc','var'),
...
if flag,
    fprintf(1,['Need to calibrate once before recomputing image corners.\n' ...
        'You can load ''Multimirror_Calib_Results.mat'' if the file is available ...\n']);
    return;
end;
...
for kk = ind_active,
    ...
    if exist(ima_name,'file')==2,
        ...
        image(I); axis image;
        colormap(gray(256));
        title(['Image ' num2str(kk) ' - New corner points (+) and old points (o)']);
        hold on;
        ...
        if flag,
            ...
            fprintf(1,'\nCheck the recomputed new corners on image %d, press any key to continue...\n', kk);
            pause;
        end;
    else
