% DIJKSTRA1 Calculate Minimum Costs and Paths using Dijkstra1's Algorithm
%
% Filename: dijkstra1.m
%
...
%
% Usage:
%     [costs,paths] = dijkstra1(A,xy)
%         -or-
%     [costs,paths] = dijkstra1(A,C)
%         -or-
%     [costs,paths] = dijkstra1(V,E)
%         -or-
%     [costs,paths] = dijkstra1(V,E3)
%         -or-
%     [costs,paths] = dijkstra1( ... ,SID,FID)
%         -or-
%     [costs,paths] = dijkstra1( ... ,SID,FID,true)
%
% Example:
...
%     I = tri(:); J = tri(:,[2 3 1]); J = J(:);
%     IJ = I + n*(J-1); A(IJ) = 1
%     [costs,paths] = dijkstra1(A,xy,1:n,2)
%
% Example:
...
%     I = delaunay(V(:,1),V(:,2));
%     J = I(:,[2 3 1]); E = [I(:) J(:)]
%     [costs,paths] = dijkstra1(V,E,[1 3 4],[2 3 5 7])
%
% Example:
...
%
function [costs,paths] = dijkstra1(AorV,xyCorE,SID,FID,showWaitbar)
    ...
    % Find the minimum costs and paths using Dijkstra1's Algorithm
    for k = 1:L
        ...
        % Execute Dijkstra1's Algorithm for this vertex
