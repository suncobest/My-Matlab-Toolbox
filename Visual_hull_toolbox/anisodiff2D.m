function diff_im = anisodiff2D(im, kappa, num_iter, flag, delta_t)
%ANISODIFF2D Conventional anisotropic diffusion
%   DIFF_IM = ANISODIFF2D(IM, KAPPA, NUM_ITER, flag, DELTA_T) perfoms
...
%                          0 - c(x,y,t) = exp(-(nablaI/kappa).^2),
%                              privileges high-contrast edges over low-contrast ones.
%                          1 - c(x,y,t) = 1./(1 + (nablaI/kappa).^2),
...
%   num_iter = 15;
%   kappa = 30;
%   ad = anisodiff2D(s, kappa, num_iter);
