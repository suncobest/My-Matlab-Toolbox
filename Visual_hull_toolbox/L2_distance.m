...
%    A - (DxM) matrix 
%    B - (DxN) matrix
%    sw = 1, force diagonals to be zero; 0 (default), do not force
% 
% Returns:
...
%    d = L2_distance(A,B);
% See also max_distance, min_distance.
...
if (nargin < 3),
   sw = 0;    % by default, do not force 0 on the diagonal
end;
