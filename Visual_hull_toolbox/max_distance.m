function [d, vec, ind, E] = max_distance(a,b)
% max_DISTANCE - computes maximum L2 Euclidean distance of two points cloud.
%
% D = max_distance(A,B)
%
%    A - (DxM) matrix 
%    B - (DxN) matrix
% 
% Returns: Max Euclidean distance between vectors in A and B
%
% Description : 
...
%    d = max_distance(A,B);
% See also min_distance, L2_distance, max_projection_vector.
