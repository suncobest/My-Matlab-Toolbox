function [cc_out, ax_out, vec_out, ind] = ellipsoid_rotation2(XX, org, ax_in, vec_in, MaxIter, frac, lambda)
% ELLIPSOID_ROTATION2 optimize orentation of a given ellipsoid to best fit
% data XX: m-dimensional points cloud.
% Input:
