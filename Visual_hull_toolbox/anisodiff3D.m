function diff_vol = anisodiff3D(vol, kappa, num_iter, flag, delta_t, voxel_spacing)
%ANISODIFF3D Conventional anisotropic diffusion
%   DIFF_VOL = ANISODIFF3D(VOL, KAPPA, NUM_ITER, flag, DELTA_T, VOXEL_SPACING) perfoms 
...
%                          0 - c(x,y,z,t) = exp(-(nablaI/kappa).^2),
%                              privileges high-contrast edges over low-contrast ones. 
%                          1 - c(x,y,z,t) = 1./(1 + (nablaI/kappa).^2),
...
%   num_iter = 4;
%   kappa = 70;
%   diff_vol = anisodiff3D(vol, kappa, num_iter);
